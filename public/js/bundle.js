...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  window.setTimeout(hideAlert, time * 1000); // Hide alert after 5 seconds
};
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alert.showAlert)('error', _t.response.data.message); // Correct error handling
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          console.error('Error logging out:', _t2);
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/minazdev/clwb484q9001v01qzc2s45271',
    // Replace with your actual Mapbox style URL
    scrollZoom: false
  });
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // public/js/updateSettings.js
/* eslint-disable */
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          url =
          // NEW: Ternary operator for URL based on type
          type === 'password' ? '/api/v1/users/updateMyPassword' // For password updates
          : '/api/v1/users/updateMe'; // For data updates
          _context.n = 1;
          return (0, _axios.default)({
            method: 'PATCH',
            // MODIFIED: Method is PATCH for both
            url: url,
            // MODIFIED: Use dynamic URL
            data: data // MODIFIED: Directly pass the data object
          });
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            // MODIFIED: Dynamic success message
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully!")); // Convert type to uppercase
            window.setTimeout(function () {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51Ras4g2Y6ZSvrFp39CWxkgRRBL9DgrvMneVoJ3dKIeUszxo6PPD3rcROsQFdgkqMQzimXTNfZ9WWQLTIgUoMMy5d00nxui5JZa');
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            ...
            passwordButton = document.querySelector('.btn--save-password'); // Select the button
            if (passwordButton) {
            ...
            password = userPasswordForm.querySelector('#password-new').value;
            passwordConfirm = userPasswordForm.querySelector('#password-new-confirm').value; // MODIFIED: Call updateSettings with password data and type 'password'
            _context2.n = 1;
          ...
          case 1:
            ...
            if (passwordButton) {
              // Ensure button exists before trying to reset text
